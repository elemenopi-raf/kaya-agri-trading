...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    api.get<PagedResponse<Product>>('/products/low-stock?pageSize=5')
  ...
  return (
    <div>
      ...
      <Row gutter={16} style={{ marginTop: 24, marginBottom: 24 }}>
        <Col span={4}><Card hoverable onClick={() => setProductModalOpen(true)}>
          <PlusOutlined /> New Product
        </Card></Col>
        <Col span={4}><Card hoverable onClick={() => setMovementModalOpen(true)}>
        ...
        <Col span={4}><Card hoverable onClick={() => setPoModalOpen(true)}>
